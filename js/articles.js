...
function createPost(postContent) {
    let postElement = '<div class="col-12 col-md-9 row post"><p class="post-header">|1|</p><p class="post-body">|2|</p><div class="col-12 row no-margin"><div class="col"><p>|3|</p></div><div class="col"><p class="post-footer">|4|</p></div></div></div>\n';
